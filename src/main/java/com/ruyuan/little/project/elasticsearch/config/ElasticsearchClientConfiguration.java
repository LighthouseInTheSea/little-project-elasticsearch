package com.ruyuan.little.project.elasticsearch.config;
...
public class ElasticsearchClientConfiguration {
     ...
     * 建立连接超时时间
     */
    @Value("${elasticsearch.connectTimeoutMillis}")
    private static int CONNECT_TIMEOUT_MILLIS;
    /**
     * 数据传输过程中的超时时间
     */
    @Value("${elasticsearch.socketTimeoutMillis}")
    private static int SOCKET_TIMEOUT_MILLIS;

    /**
     * 从连接池获取连接的超时时间
     */
    @Value("${elasticsearch.connectionRequestTimeoutMillis}")
    private static int CONNECTION_REQUEST_TIMEOUT_MILLIS;
